    ...
    <ul class="menu-inner py-1">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('rating.index') }}" class="menu-link">
                            <div data-i18n="Without navbar">Ratings</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('application.index') }}" class="menu-link">
                            <div data-i18n="Without navbar">Applications</div>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        @if(Auth::user()->level_id === \App\Models\Levels::USER || Auth::user()->level_id === \App\Models\Levels::ADMIN || Auth::user()->level_id === \App\Models\Levels::MANAGER)
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    @if(\App\Models\Offer::where('user_id', Auth::user()->id)->exists())
                        <li class="menu-item">
                    ...
                    @if(\App\Models\Post::where('user_id', Auth::user()->id)->exists())
                        <li class="menu-item">
                            <a href="{{ route('posts.user') }}" class="menu-link">
                                <div data-i18n="Without navbar">Posts</div>
                            </a>
                        </li>
                    @endif
        ...
        @if(Auth::user()->level_id === \App\Models\Levels::WORKER || Auth::user()->level_id === \App\Models\Levels::ADMIN || Auth::user()->level_id === \App\Models\Levels::MANAGER)
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    @if(\App\Models\Offer::where('user_id', auth()->user()->id)->where('accepted', 1)->get()->count() > 0)
                        <li class="menu-item">
        ...
        @endif
        @if(Auth::user()->level_id === \App\Models\Levels::ADMIN || Auth::user()->level_id === \App\Models\Levels::MANAGER)
            <li class="menu-header small text-uppercase">
