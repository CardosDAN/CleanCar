                        ...
                        <div class="col-lg-8 mb-4 order-0">
                            <div class="card">
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-7">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary">{{__("Greetings ")}}  {{auth()->user()->name}} ! 🎉 </h5>
                                            <p class="mb-4">
                                            ...
                                            <div class="card-title d-flex align-items-start justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                                        <a class="dropdown-item" href="{{route('user.index')}}">{{__("View More")}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="card-title d-flex align-items-start justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                                        <a class="dropdown-item" href="{{route('posts.index')}}">{{__("View More")}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <span>{{__("Posts")}}</span>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <span class="badge bg-label-warning rounded-pill">{{__("Year 2023")}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
